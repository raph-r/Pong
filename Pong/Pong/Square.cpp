...
bool Square::pos_is_between_horizontal_borders(const int & pos)
{
	return this->top_left_x <= pos && pos <= (this->top_left_x + this->width);
}

bool Square::pos_is_between_vertical_borders(const int & pos)
{
...
bool Square::collided_on_top_of_other_square(const Square const * other_square)
{
	...
	{
		if (this->pos_is_between_horizontal_borders(other_square->top_left_x) || this->pos_is_between_horizontal_borders(other_square->top_left_x + other_square->width))
		{
			return true;
		}
	}
...
bool Square::collided_on_left_of_other_square(const Square const * other_square)
{
	...
	{
		if (this->pos_is_between_vertical_borders(other_square->top_left_y) || this->pos_is_between_vertical_borders(other_square->top_left_y + other_square->height))
		{
			return true;
		}
	}
