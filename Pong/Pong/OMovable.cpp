...
OMovable::OMovable(const int& top_left_x, const int& top_left_y, const int& width, const int& height, const int& acceleration_x, const int& acceleration_y) :
	Object(top_left_x, top_left_y, width, height)
{
